    ...
    <section className="relative w-full h-[80vh] min-h-[600px] flex items-center overflow-hidden">
      ...
      <div 
        ...
        style={{
          ...
          backgroundImage: 'repeating-linear-gradient(45deg, rgba(0,0,0,0.1) 0px, rgba(0,0,0,0.1) 2px, transparent 2px, transparent 8px)'
        }}
      ></div>
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center justify-between h-full">
        ...
        <div className="flex flex-col text-white w-full md:w-1/2 pt-20 md:pt-0">
          <div className="mb-6">
            ...
            <p className="font-serif-tc font-bold text-xl md:text-3xl tracking-widest text-cream">內湖五期超新星</p>
          </div>

          <div className="mb-10 relative">
            <h4 className="text-gray-300 font-en-serif tracking-[0.2em] text-xs md:text-sm mb-3">P R O J E C T &nbsp; M A N A G E R</h4>
            <h1 className="font-serif-tc font-black text-5xl md:text-7xl tracking-widest mb-4 text-white">黃阿偉</h1>
            <p className="text-gray-300 font-sans-tc text-sm md:text-base tracking-widest">內湖五期店 專案經理</p>
